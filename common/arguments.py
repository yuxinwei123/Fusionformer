...
def parse_args():
    ...
    parser.add_argument('-b', '--batch-size', default=1, type=int, metavar='N', help='batch size in terms of predicted frames')
    ...
    parser.add_argument('-frame', '--number-of-frames', default='243', type=int, metavar='N',
